Pod::Spec.new do |s|
  ...
  s.name         = "LoginCritter"
  s.version      = "0.0.1"
  s.summary      = "An animated avatar that responds to text fields interactions 🐻"
...
Questions? Comments? I would love to hear your feedback. :heart:
  ...
  s.homepage     = "https://github.com/cgoldsby/LoginCritter"
  s.license      = "MIT License"
  s.author       = { "cgoldsby" => "cgoldsby@gmail.com" }
  s.source       = { :git => "https://github.com/cgoldsby/LoginCritter.git", :tag => "#{s.version}" }

  s.source_files = "LoginCritter/Sources/{Login,Helpers}/**/*.swift"
  s.resources    = 'LoginCritter/Resources/*.{xcassets}'
  s.platform     = :ios, "11.0"
  s.swift_version = '4.2'
end
